...
",
		...
		cPlayer =
		{
			...
			Functions =
			{
				...
				SetCapabilities =
				{
					Notes = "Updates player's capabilities - flying, visibility, etc. from their gamemode.",
				},
				SetCrouch =
				{
					Params =
		...
		Globals =
		{
			...
			Functions =
			{
				...
				GetSnowStartHeight =
				{
					...
					Notes = "Returns the height at which snow will start falling in the {{EMCSBiome}|Biome}}.",
				},
				GetTime =
				{
					Returns =
